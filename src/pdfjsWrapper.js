    ...
    function PDFJSWrapper(canvasElt, annotationLayerElt, emitEvent) {
        ...
        this.printPage = function (dpi, pageNumberOnly) {
            ...
            function removePrintContainer() {
                printContainerElement.parentNode.removeChild(
                    printContainerElement
                );
            }
                    ...
                    for (
                        ...
                        allPages.push(
                            pdfDoc.getPage(pageNumber).then(function (page) {
                                ...
                                printCanvasElt.setAttribute(
                                    'id',
                                    'print-canvas'
                                );
                                printCanvasElt.width =
                                    viewport.width * PRINT_UNITS;
                                printCanvasElt.height =
                                    viewport.height * PRINT_UNITS;

                                return page.render({
                                    canvasContext:
                                        printCanvasElt.getContext('2d'),
                                    transform: [
